...
import CanceledOrdersActionButton from "../../ActionButtons/HomePageActionButton/CanceledOrdersActionButton";
import CanceledIndicator from "../Indicators/CanceledIndicator";
import { canceledOrdersData } from "../TableData/CanceledOrdersData";

const CanceledOrdesTable = () => {
            ...
            {canceledOrdersData
              ...
              .map((data) => (
                ...
                >
                  ...
                  <TableCell align="right">
                    {data.status === "Canceled" ? <CanceledIndicator /> : null}
                  </TableCell>
                  <TableCell align="right">{data.amount}</TableCell>
                  <TableCell align="right">
                    <CanceledOrdersActionButton />
                  </TableCell>
                </TableRow>
              ))}
          </TableBody>
...
export default CanceledOrdesTable;
