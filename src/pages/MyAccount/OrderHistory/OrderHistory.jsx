    ...
    <div>
      ...
      <div className="mt-[50px] md:px-[150px] px-[20px] mb-[100px]">
        <div className="flex md:flex-row flex-col w-full md:h-[80vh] ">
          ...
          <div className="flex-[3] bg-gray-100 md:p-[25px] p-[10px] pt-[50px] Nu flex flex-col gap-[25px] myAc overflow-y-scroll">
            {/* top */}
              ...
              <div>
                ...
                <div className="flex items-center gap-[10px]">
                  ...
                  >
                    ...
                    <option value="op4">Cancelled Orders</option>
            ...
            <div className="flex flex-col gap-[50px]">
              {orders.length > 0 &&
                orders.map((item) => <OrderCard item={item} key={item.id} />)}
            </div>
              ...
              <div className="mt-[100px]">
                <div className="flex flex-col justify-center items-center gap-[25px]">
                  <span className="text-[25px] Nu font-[600] text-center flex">
                    Your leather journey awaits! Let's craft some unforgettable
                    orders together! You haven't bought anything yet
                  </span>
